  ...
  return (
    <Layout breakingArticles={breakingArticles}>
      <div className="article-page">
        ...
        {article.image
          ? <img src={article.image} alt={article.title} style={{ width: '100%', maxHeight: 400, objectFit: 'cover', borderRadius: 8, marginBottom: 28, display: 'block' }} />
        ...
        {article.desc && <div className="article-page-desc">{article.desc}</div>}
        ...
        {related.length > 0 && (
          <div style={{ marginTop: 40, paddingTop: 24, borderTop: '2px solid var(--border)' }}>
            ...
            {related.map(a => (
              <div key={a.id} style={{ padding: '12px 0', borderBottom: '1px solid var(--border)', display: 'flex', gap: 12, alignItems: 'center' }}>
                {a.image && <img src={a.image} alt={a.title} style={{ width: 60, height: 48, objectFit: 'cover', borderRadius: 4, flexShrink: 0 }} />}
                <div>
